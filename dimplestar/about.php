...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <h1>ABOUT US</h1><br>
                ...
                <h3><img src="images/history.png" alt="History icon" style="vertical-align: middle; margin-right: 5px;">History</h3>
                ...
                <table style="width:55%">
                    <tr>
                    <br>
                    <td><h3><img src="images/Mission.png" alt="Mission icon" style="vertical-align: middle; margin-right: 5px;">Mission</h3></td>
                    <td><h3><img src="images/Vision.png" alt="Vision icon" style="vertical-align: middle; margin-right: 5px;">Vision</h3></td>
                    </tr>
                    <tr>
